...
set grid
set xtics 0.1
plot [150:151] "ss3_02" u 1:3

set origin 0.0,0.48
set size 0.5,0.16
set grid
set xtics 0.1
plot [150:151] "ss3_20" u 1:3

set origin 0.0,0.64
set size 0.5,0.16
set grid
set xtics 0.1
plot [150:151] "ss3_03" u 1:3

set origin 0.0,0.80
set size 0.5,0.16
set grid
set xtics 0.1
plot [150:151] "ss3_30" u 1:3
...
set grid
set xtics 0.1
plot [150:151] "ss3_13" u 1:3

set origin 0.5,0.48
set size 0.5,0.16
set grid
set xtics 0.1
plot [150:151] "ss3_31" u 1:3
