...
if [ $# -ne 2 ] ; 
  ...
  rm -rf lm1b/out_bs$1_moe$2
  rm -f bs$1_moe$2.*
  mkdir lm1b/out_bs$1_moe$2
  nvprof -f --quiet --profile-api-trace none --print-gpu-trace --print-nvlink-topology --csv --log-file bs$1_moe$2.csv -o bs$1_moe$2.nvvp \
    ...
    --data_dir=lm1b/data \
    --output_dir=lm1b/out_bs$1_moe$2 \
    --tmp_dir=lm1b/tmp 2> >(tee log_bs$1_moe$2.log)
fi
