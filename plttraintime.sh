...
echo -n "8 " >> bs8192_moe16.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe16_gpu8.csv |awk '{print $NF}'  >> bs8192_moe16.traintime
...
echo -n "8 " >> bs8192_moe32.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe32_gpu8.csv |awk '{print $NF}'  >> bs8192_moe32.traintime
...
echo -n "8 " >> bs8192_moe64.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe64_gpu8.csv |awk '{print $NF}'  >> bs8192_moe64.traintime
...
echo -n "8 " >> bs8192_moe128.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe128_gpu8.csv |awk '{print $NF}'  >> bs8192_moe128.traintime
...
echo -n "8 " >> bs8192_moe256.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe256_gpu8.csv |awk '{print $NF}'  >> bs8192_moe256.traintime

rm -f bs8192_moe512.traintime
echo -n "4 " >> bs8192_moe512.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe512_gpu4.csv |awk '{print $NF}'  >> bs8192_moe512.traintime
echo -n "8 " >> bs8192_moe512.traintime  ; $(dirname "$0")/seperate.sh  bs8192_moe512_gpu8.csv |awk '{print $NF}'  >> bs8192_moe512.traintime
