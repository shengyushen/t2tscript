...
if [ $# -ne 2 ] ; 
  ...
  rm -rf lm1b/out_bs$1_moe$2_1gpu
  rm -f bs$1_moe$2_1gpu.*
  mkdir lm1b/out_bs$1_moe$2_1gpu
  nvprof -f --quiet --profile-api-trace none --print-gpu-trace --print-nvlink-topology  --csv --log-file bs$1_moe$2_1gpu.csv -o bs$1_moe$2_1gpu.nvvp \
    ...
    --data_dir=lm1b/data \
    --output_dir=lm1b/out_bs$1_moe$2_1gpu \
    --tmp_dir=lm1b/tmp 2> >(tee bs$1_moe$2_1gpu.log)
fi
